...
Please contribute to this collaborative discussion. Build on previous responses and add your expertise."""
    ...
    def add_member(self, member: Union[Agent, "Team"]) -> None:
        """Add a member to the team."""
        self.members.append(member)
        if self.debug_mode:
            log_debug(f"Added member to team: {member.name or 'Unnamed'}")

    def remove_member(self, member: Union[Agent, "Team"]) -> bool:
    ...
    def get_member_by_name(self, name: str) -> Optional[Union[Agent, "Team"]]:
    ...
    def __repr__(self) -> str:
        return f"Team(name='{self.name}', id='{self.team_id}', members={len(self.members)}, mode='{self.mode}')"
